  ...
  return (
    ...
    >
      <div className="relative w-1/2 h-60">
        <img
          className="absolute bottom-14 left-10 z-10"
          src={props.img1SRC}
          alt="img"
        />
      ...
      <div
        className="flex flex-col items-center lg:items-end justify-start gap-4
                w-1/2 h-60"
      >
        <span className={`text-xs ${getNameColor()}`}>{props.name}</span>
